...
(function ($) {
  ...
  if (version.major === '4') {
    ...
    classNames.BUTTONCLASS = 'btn-round btn-simple';
  ...
  if (version.major === '4') {
    Selectpicker.DEFAULTS.style = 'btn-round btn-simple';
  ...
  function Plugin(option) {
    ...
    if (!version.success) {
      ...
      if (version.major === '4') {
        ...
        classNames.SHOW = 'show';
        classNames.BUTTONCLASS = 'btn-round btn-simple';
        Selectpicker.DEFAULTS.style = classNames.BUTTONCLASS = 'btn-round btn-simple';
        classNames.POPOVERHEADER = 'popover-header';
      }
    }
